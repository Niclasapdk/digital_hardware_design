...
HD_PWD='C:/Users/nicla/Documents/GitHub/digital_hardware_design/lecture2/Exercise1lec2/exercise1lec2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Exercise1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Exercise1.tcl -notrace
